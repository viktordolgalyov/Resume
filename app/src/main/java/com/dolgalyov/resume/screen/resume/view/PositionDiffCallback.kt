...
class PositionDiffCallback : DiffUtil.ItemCallback<PositionListItem>() {
    override fun areItemsTheSame(oldItem: PositionListItem, newItem: PositionListItem): Boolean {
        return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: PositionListItem, newItem: PositionListItem): Boolean {
